...
CREATE TABLE IF NOT EXISTS bot_config(
    ...
    main_img TEXT DEFAULT 'https://imgur.com/a/HE1V0OM.png',  -- Link da imagem do /start
    support_user TEXT DEFAULT '@olimpiachecker',                               -- Username de atendimento
    channel_user TEXT DEFAULT '@olimpiareferencias',                                    -- Canal de notícias
...
-- Db de cartões vendidos --
CREATE TABLE IF NOT EXISTS ggs_sold(
    number TEXT PRIMARY KEY NOT NULL,
    month TEXT NOT NULL,                                                  -- Mês do vencimento
    year TEXT NOT NULL,                                                   -- Ano do vencimento
    cvv TEXT NOT NULL,                                                    -- Dígito verificador
...
-- Db de cartões die e trocas --
CREATE TABLE IF NOT EXISTS ggs_dies(
    number TEXT PRIMARY KEY NOT NULL,
    month TEXT NOT NULL,                                                 -- Mês do vencimento
    year TEXT NOT NULL,                                                  -- Ano do vencimento
    cvv TEXT NOT NULL,                                                   -- Dígito verificador
...
cur.execute("UPDATE contas SET pending = 0")
